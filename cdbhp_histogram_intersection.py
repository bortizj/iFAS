...
def cd01_hist_diff_patches(Ref_image, Pro_image, th=0.010, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd02_hist_diff_patches(Ref_image, Pro_image, th=0.015, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd03_hist_diff_patches(Ref_image, Pro_image, th=0.020, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd04_hist_diff_patches(Ref_image, Pro_image, th=0.025, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd05_hist_diff_patches(Ref_image, Pro_image, th=0.03, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd06_hist_diff_patches(Ref_image, Pro_image, th=0.035, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd07_hist_diff_patches(Ref_image, Pro_image, th=0.040, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd08_hist_diff_patches(Ref_image, Pro_image, th=0.045, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
...
def cd09_hist_diff_patches(Ref_image, Pro_image, th=0.05, r=3, nbins=8, local_maxmin=True):
    SE = np.ones((np.int_(2 * r + 1), np.int_(2 * r + 1)))
    Lab_ref = color.rgb2lab(Ref_image)
    L_ref = Lab_ref[:, :, 0]
    a_ref = Lab_ref[:, :, 1]
